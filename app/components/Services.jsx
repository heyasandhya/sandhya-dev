import { assets, serviceData } from '@/asset/assets'
...
const Services = () => {
	return (
		<div id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
			...
			<p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>I build modern, responsive websites with clean and intuitive interfaces.
				I turn ideas into smooth, engaging digital experiences that feel effortless to use.
				Focused on clean code, thoughtful design, performance, and seamless user experiences.</p>
