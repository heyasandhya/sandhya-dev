...
const Header = () => {
	return (
		<div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
			...
			<h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-ovo'>Hi! I'm Sandhya Kumari <Image src={assets.hand_icon} alt='' className='w-6' /></h3>
			<h1 className='text-3xl sm:text-6xl lg:text-[66px] font-ovo'>
				frontend web developer based in london.</h1>
			<p className='max-w-2xl mx-auto font-ovo'>
				Turning ideas into beautiful, responsive web experiences.</p>
